                ...
                <div id="search" class="mx-auto w-1/4">
                    <form class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="default-search" class="block py-4 pl-10 w-full text-sm text-white bg-gray-500 rounded-lg border-gray-300 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Busque entre los productos..." required />
