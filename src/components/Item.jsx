...
export const Item = ({ key, title, thumbnail, short_description, game_url }) => {
    ...
    return (
        <div id={key} className="max-w-lg m-auto card">
            <div className="bg-slate-200 bg-zinc-700 rounded-lg max-w-sm p-4">
                ...
                <div className="p-2 text-slate-300">
                    ...
                    <div className="w-full flex justify-between">
                        <a className="text-white bg-blue-700 hover:opacity-75 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center" href="#">
                            Agregar
                        </a>
